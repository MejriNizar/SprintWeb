...
class Produit
{
    ...
    private $etoile = '3';
    /**
     * @var ProduitsBundle\Entity\Fournisseur
     * @ORM\ManyToOne(
     *     targetEntity="ProduitsBundle\Entity\Fournisseur",
     *
     * )
    ...
    /**
     * @param mixed $fournisseur_id
     */
    public function setFournisseurId($fournisseur_id)
    {
